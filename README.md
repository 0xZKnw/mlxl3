...
| Same target with experimental lossless DFlash2 | **63.716 tok/s** cool-state median | Draft-context setup 0.007–0.008 s | **+34.2%** cool / +33.8% hot, five proposals per block, 86.7% accepted, exact sequences |
